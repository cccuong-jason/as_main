...
class DesignGenerator:
    ...
    def generate_design(self, order_id: str, prompt: str, style: Optional[str] = None) -> DesignGenerationResult:
    ...
    def get_design(self, design_id: str) -> DesignGenerationResult:
        ...
        try:
            ...
            if not design:
                return DesignGenerationResult(
                    success=False,
                    error=f"Design with ID {design_id} not found"
                )
