...
def admin_data():
    ...
    return {"id": "admin123", "username": "admin", "email": "admin@example.com", "role": "admin"}
...
def mock_payment_service():
    ...
    class MockPaymentService:
        def process_payment(self, amount, payment_details):
            return {"success": True, "transaction_id": "txn_123456", "amount": amount}

        def refund_payment(self, transaction_id):
            return {"success": True, "refund_id": "ref_123456", "transaction_id": transaction_id}
